...
check_contains "README.md" "docs/vision.md"
check_contains "README.md" "docs/requirements.md"
check_contains "README.md" "docs/architecture.md"
check_contains "README.md" "docs/architecture/source-map.md"
check_contains "README.md" "docs/decisions.md"
check_contains "README.md" "docs/testing.md"
check_contains "README.md" "docs/release-checklist.md"
check_contains "README.md" "docs/process/development-loop.md"
check_contains "README.md" "docs/process/git-workflow.md"
check_contains "README.md" "docs/process/roadmap-vs-tasks.md"
check_contains "README.md" "docs/process/versioning.md"
check_contains "README.md" "docs/tasks/task-template.md"
check_contains "README.md" "docs/tasks/current-priorities.md"
check_contains "README.md" "docs/tasks/backlog.md"
check_contains "README.md" "docs/assets/brand-assets.md"
